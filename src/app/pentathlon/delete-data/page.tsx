// src/app/pentathlon/delete-data/page.tsx
"use client";
...
export default function PentathlonDeleteDataPage() {
    const { lang } = useLanguage();
    // 'pentathlonData' içeriğini çekiyoruz
    const t = deleteAccountContent.pentathlonData[lang];
        ...
        <div className="min-h-screen bg-white text-black selection:bg-[#B9FF66] selection:text-black overflow-x-hidden flex flex-col">
            ...
            <main className="flex-grow w-full relative z-10 max-w-[800px] mx-auto px-6 pt-12 md:pt-20 pb-20">
                ...
                <div className="w-full bg-white rounded-[20px] border border-gray-200 shadow-lg overflow-hidden relative min-h-[850px]">
                    ...
                    {/* VERİ SİLME FORMU (Yeni Link) */}
                    <iframe 
                        src="https://docs.google.com/forms/d/e/1FAIpQLScLbGGMaWCbP6gW6j7G2_agIKGGCt576svzyGEEO7J8iHXFZw/viewform?embedded=true" 
